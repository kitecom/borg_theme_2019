...
<section class="facets-facet-browse">
	...
	{{else}}
		<div class="facets-facet-browse-empty-items" data-view="Facets.Items.Empty" data-template="my_facet_items_empty" data-phone-template="my_facet_items_empty_phone" data-tablet-template="my_facet_items_empty_tablet">
		</div>
	{{/if}}
