		...
		<section class="product-details-full-main-content">
			...
			<div class="product-details-full-main-content-right">
				<div class="product-details-full-content-header">
					...
					<p class="product-details-full-content-header-desc" itemprop="description">{{model.item.storedescription}}</p>
					...
					{{else}}
						...
						{{#if model.item.custitem_facet_part_type}}
							<div class="product-details-full-content-store-facet-part-type">
								<span>Part Type: </span>{{model.item.custitem_facet_part_type}}</span>
							</div>
						{{/if}}
